...
<script>
    ...
    <div class="container">
        <div class="jumbotron text-center">
            <h1 class="display-4">CATEGORIA A</h1>
...
<div class="text-center">
    <a class="btn btn-secondary mt-3" href="resultados_relevo4x50metros_ca.php" style="background-color: blue; border-color: blue; color: white;">Agregar resultados a resultados_relevo4x50metros_ca</a>
</div>
...
function mostrarFormularioSeleccion($conn, $mensaje = "") {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_row()) {
            $tabla = $row[0];
            if (in_array(substr($tabla, -2), ['ca']) && $tabla !== 'resultados_relevo4x50metros_ca') {
